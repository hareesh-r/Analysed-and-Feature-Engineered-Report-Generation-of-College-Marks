...
sheet1 = wb.add_sheet('Model Assessment') 
...
sheet1.write(i,1,str(inp)+"-Q1 (2 MARKS)")
sheet1.write(i,2,str(inp)+"-Q2 (2 MARKS)")
sheet1.write(i,3,str(inp)+"-Q11 (13 MARKS)")

sheet1.write(i,4,str(inp)+"-Q3 (2 MARKS)")
sheet1.write(i,5,str(inp)+"-Q4 (2 MARKS)")
sheet1.write(i,6,str(inp)+"-Q12 (13 MARKS)")

sheet1.write(i,7,str(inp)+"-Q5 (2 MARKS)")
sheet1.write(i,8,str(inp)+"-Q6 (2 MARKS)")
sheet1.write(i,9,str(inp)+"-Q13(13 MARKS)")
sheet1.write(i,10,str(inp)+"-Q16A (15 MARKS)")

sheet1.write(i,11,str(inp)+"-Q7 (2 MARKS)")
sheet1.write(i,12,str(inp)+"-Q8 (2 MARKS)")
sheet1.write(i,13,str(inp)+"-Q14 (13 MARKS)")

sheet1.write(i,14,str(inp)+"-Q9 (2 MARKS)")
sheet1.write(i,15,str(inp)+"-Q10 (2 MARKS)")
sheet1.write(i,16,str(inp)+"-Q15 (13 MARKS)")
sheet1.write(i,17,str(inp)+"-Q16B (15 MARKS)")


sheet1.write(i+3,1,"CO1")
sheet1.write(i+3,4,"CO2")
sheet1.write(i+3,7,"CO3")
sheet1.write(i+3,11,"CO4")
sheet1.write(i+3,14,"CO5")
sheet1.write(i+3,17,"CO6")
...
for j in range(1,sheet.ncols-4):
    if j==1:
        ...
        sheet1.write(i+4,j,int(P151+P152/Q151+Q152*100))
    elif j==17:
        sheet1.write(i+4,j,int(P162/Q162*100))
i+=1

avg1 = (int(P1/Q1*100) + int(P2/Q2*100) + int(P11/Q11*100))/3
avg2 = (int(P3/Q4*100) + int(P4/Q4*100) + int(P12/Q12*100))/3
avg3 = (int(P5/Q5*100) + int(P6/Q6*100) + int(P13/Q13*100) + int(P161/Q161*100))/4
avg4 = (int(P7/Q7*100) + int(P8/Q8*100) + int(P14/Q14*100))/3
avg5 = (int(P9/Q9*100) + int(P10/Q10*100) + int(((P151+P152)/(Q151+Q152))*100))/3
avg6 = (int(P162/Q162*100))

sheet1.write(i+4,1,avg1)
sheet1.write(i+4,4,avg2)
sheet1.write(i+4,7,avg3)
sheet1.write(i+4,11,avg4)
sheet1.write(i+4,14,avg5)
sheet1.write(i+4,17,avg6)

i+=1
def attr(avg,i,index):
    att = 1
    if avg1>70:
        att = 3
    elif avg1>60:
        att = 2
    sheet1.write(i+4,index,att)
attr(avg1,i,1)
attr(avg2,i,4)
attr(avg3,i,7)
attr(avg4,i,11)
